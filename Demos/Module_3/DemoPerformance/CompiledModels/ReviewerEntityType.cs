...
namespace DemoPerformance
{
    internal partial class ReviewerEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            var credentialsId = runtimeEntityType.AddProperty(
                "CredentialsId",
                typeof(long?),
                nullable: true);
            credentialsId.TypeMapping = SqlServerLongTypeMapping.Default.Clone(
                comparer: new ValueComparer<long?>(
                ...
                providerValueComparer: new ValueComparer<long?>(
                    ...
                    (Nullable<long> v) => v.HasValue ? ((long)v).GetHashCode() : 0,
                    (Nullable<long> v) => v.HasValue ? (Nullable<long>)(long)v : default(Nullable<long>)));
            credentialsId.AddAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.None);
        ...
        {
            var runtimeForeignKey = declaringEntityType.AddForeignKey(new[] { declaringEntityType.FindProperty("CredentialsId") },
                principalEntityType.FindKey(new[] { principalEntityType.FindProperty("Id") }),
                principalEntityType);

            var credentials = declaringEntityType.AddNavigation("Credentials",
                runtimeForeignKey,
                onDependent: true,
